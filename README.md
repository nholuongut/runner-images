...
[ubuntu-22.04]: https://github.com/nholuongut/runner-images/blob/main/images/ubuntu/Ubuntu2204-Readme.md
[ubuntu-20.04]: https://github.com/nholuongut/runner-images/blob/main/images/ubuntu/Ubuntu2004-Readme.md
[windows-2022]: https://github.com/nholuongut/runner-images/blob/main/images/windows/Windows2022-Readme.md
[windows-2019]: https://github.com/nholuongut/runner-images/blob/main/images/windows/Windows2019-Readme.md
[macOS-11]: https://github.com/nholuongut/runner-images/blob/main/images/macos/macos-11-Readme.md
[macOS-12]: https://github.com/nholuongut/runner-images/blob/main/images/macos/macos-12-Readme.md
[macOS-13]: https://github.com/nholuongut/runner-images/blob/main/images/macos/macos-13-Readme.md
[self-hosted runners]: https://help.github.com/en/actions/hosting-your-own-runners

## Announcements

See notable upcoming changes by viewing issues with the [Announcement](https://github.com/nholuongut/runner-images/labels/Announcement) label.
...
1. Find the latest releases for this repository [here.](https://github.com/nholuongut/runner-images/releases)
...
3. Upcoming changes: A pre-release is created when the deployment of an image has started. As soon as the deployment is finished, the pre-release is converted to a release. If you have subscribed to releases, you will get notified of pre-releases as well.
   ...
   - You can also track upcoming changes using the [awaiting-deployment](https://github.com/nholuongut/runner-images/labels/awaiting-deployment) label.
...
- **Issues**: To file a bug report, or request tools to be added/updated, please [open an issue using the appropriate template](https://github.com/nholuongut/runner-images/issues/new/choose)
- **Discussions**: If you want to share your thoughts about image configuration, installed software, or bring a new idea, please create a new topic in a [discussion](https://github.com/nholuongut/runner-images/discussions) for a corresponding category. Before making a new discussion please make sure no similar topics were created earlier.
